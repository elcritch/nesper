...
"eques.nim");	{		NI correctSizeX60gensym178_;		NI TM__NdgYN5HU2ty0qMI5oazWyg_2;
...
"eques.nim");
#line 70 "/Users/elcritch/.asdf/installs/nim/devel/lib/pure/collections/deques.nim"
		correctSizeX60gensym178_ = nextPowerOfTwo__v2qC0V55wqa9bmqc7eHTz8A(((NI) 4));		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
...
"eques.nim");
#line 71 "/Users/elcritch/.asdf/installs/nim/devel/lib/pure/collections/deques.nim"
		if (nimSubInt(correctSizeX60gensym178_, ((NI) 1), &TM__NdgYN5HU2ty0qMI5oazWyg_2)) { raiseOverflow(); goto BeforeRet_;};		(*deq).mask = (NI)(TM__NdgYN5HU2ty0qMI5oazWyg_2);
...
"eques.nim");		if ((correctSizeX60gensym178_) < ((NI) 0) || (correctSizeX60gensym178_) > ((NI) 2147483647)){ raiseRangeErrorI(correctSizeX60gensym178_, ((NI) 0), ((NI) 2147483647)); goto BeforeRet_;}		(*deq).data.len = ((NI) (correctSizeX60gensym178_)); (*deq).data.p = (tySequence__aNpJjaoUowCQc7fBn3wtDQ_Content*) newSeqPayload(((NI) (correctSizeX60gensym178_)), sizeof(tyProc__HzVCwACFYM9cx9aV62PdjtuA), NIM_ALIGNOF(tyProc__HzVCwACFYM9cx9aV62PdjtuA));	}
	LA3_: ;
...
"eques.nim");
#line 2101 "/Users/elcritch/.asdf/installs/nim/devel/lib/system.nim"
		nimln_(2101, "/Users/elcritch/.asdf/installs/nim/devel/lib/system.nim");		T7_ = (NIM_BOOL)0;		T7_ = NIM_UNLIKELY((cap <= (*deq).count));		if (!T7_) goto LA8_;
		n.len = 0; n.p = NIM_NIL;
