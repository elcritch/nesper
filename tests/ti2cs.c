...
static void register_i2cconfig(void)
{
    ...
    const esp_console_cmd_t i2cconfig_cmd;
        ...
        i2cconfig_cmd.hint = NULL;
        i2cconfig_cmd.func = &do_i2cconfig_cmd;
        i2cconfig_cmd.argtable = &i2cconfig_args;
...
static void register_i2cget(void)
{
    ...
    const esp_console_cmd_t i2cget_cmd;
        ...
        i2cget_cmd.hint = NULL;
        i2cget_cmd.func = &do_i2cget_cmd;
        i2cget_cmd.argtable = &i2cget_args;
...
static void register_i2cset(void)
{
    ...
    const esp_console_cmd_t i2cset_cmd;
        ...
        i2cset_cmd.hint = NULL;
        i2cset_cmd.func = &do_i2cset_cmd;
        i2cset_cmd.argtable = &i2cset_args;
...
static void register_i2cdump(void)
{
    ...
    const esp_console_cmd_t i2cdump_cmd;
        ...
        i2cdump_cmd.hint = NULL;
        i2cdump_cmd.func = &do_i2cdump_cmd;
        i2cdump_cmd.argtable = &i2cdump_args;
