...
import
  esp_err, esp_intr_alloc, freertos/FreeRTOS, freertos/semphr, freertos/xtensa_api,
  freertos/task, freertos/queue, freertos/ringbuf, driver/gpio

const
  I2C_APB_CLK_FREQ* = APB_CLK_FREQ
  I2C_FIFO_LEN* = (32)          ## !< I2C hardware fifo length
...
type
  INNER_C_STRUCT_i2c_91* {.importc: "no_name", header: "i2c.h", bycopy.} = object
    clk_speed* {.importc: "clk_speed".}: uint32_t ## !< I2C clock frequency for master mode, (no higher than 1MHz for now)

  INNER_C_STRUCT_i2c_94* {.importc: "no_name", header: "i2c.h", bycopy.} = object
  ...
  INNER_C_UNION_i2c_90* {.importc: "no_name", header: "i2c.h", bycopy.} = object {.union.}
    master* {.importc: "master".}: INNER_C_STRUCT_i2c_91
    slave* {.importc: "slave".}: INNER_C_STRUCT_i2c_94

  i2c_config_t* {.importc: "i2c_config_t", header: "i2c.h", bycopy.} = object
    mode* {.importc: "mode".}: i2c_mode_t ## !< I2C mode
    sda_io_num* {.importc: "sda_io_num".}: gpio_num_t ## !< GPIO number for I2C sda signal
    sda_pullup_en* {.importc: "sda_pullup_en".}: gpio_pullup_t ## !< Internal GPIO pull mode for I2C sda signal
    scl_io_num* {.importc: "scl_io_num".}: gpio_num_t ## !< GPIO number for I2C scl signal
    scl_pullup_en* {.importc: "scl_pullup_en".}: gpio_pullup_t ## !< Internal GPIO pull mode for I2C scl signal
    ano_i2c_98* {.importc: "ano_i2c_98".}: INNER_C_UNION_i2c_90
...
proc i2c_driver_delete*(i2c_num: i2c_port_t): esp_err_t {.
    importc: "i2c_driver_delete", header: "i2c.h".}
## *
...
proc i2c_set_pin*(i2c_num: i2c_port_t; sda_io_num: cint; scl_io_num: cint;
                 sda_pullup_en: gpio_pullup_t; scl_pullup_en: gpio_pullup_t;
                 mode: i2c_mode_t): esp_err_t {.importc: "i2c_set_pin",
    header: "i2c.h".}
## *
...
proc i2c_master_write_byte*(cmd_handle: i2c_cmd_handle_t; data: uint8_t; ack_en: bool): esp_err_t {.
...
proc i2c_master_write*(cmd_handle: i2c_cmd_handle_t; data: ptr uint8_t;
...
proc i2c_master_read_byte*(cmd_handle: i2c_cmd_handle_t; data: ptr uint8_t;
...
proc i2c_master_read*(cmd_handle: i2c_cmd_handle_t; data: ptr uint8_t;
...
proc i2c_slave_write_buffer*(i2c_num: i2c_port_t; data: ptr uint8_t; size: cint;
...
proc i2c_slave_read_buffer*(i2c_num: i2c_port_t; data: ptr uint8_t; max_size: csize_t;
                           ticks_to_wait: TickType_t): cint {.
...
proc i2c_filter_enable*(i2c_num: i2c_port_t; cyc_num: uint8_t): esp_err_t {.
