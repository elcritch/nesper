...
import
  soc/uart_periph, soc/uart_caps, esp_err, esp_intr_alloc, driver/periph_ctrl,
  freertos/FreeRTOS, freertos/semphr, freertos/xtensa_api, freertos/task,
  freertos/queue, freertos/ringbuf
...
type
  uart_config_t* {.importc: "uart_config_t", header: "uart.h", bycopy.} = object
    ...
    rx_flow_ctrl_thresh* {.importc: "rx_flow_ctrl_thresh".}: uint8_t ## !< UART HW RTS threshold
...
type
  uart_intr_config_t* {.importc: "uart_intr_config_t", header: "uart.h", bycopy.} = object
    intr_enable_mask* {.importc: "intr_enable_mask".}: uint32_t ## !< UART interrupt enable mask, choose from UART_XXXX_INT_ENA_M under UART_INT_ENA_REG(i), connect with bit-or operator
    rx_timeout_thresh* {.importc: "rx_timeout_thresh".}: uint8_t ## !< UART timeout interrupt threshold (unit: time of sending one byte)
    txfifo_empty_intr_thresh* {.importc: "txfifo_empty_intr_thresh".}: uint8_t ## !< UART TX empty interrupt threshold.
    rxfifo_full_thresh* {.importc: "rxfifo_full_thresh".}: uint8_t ## !< UART RX full interrupt threshold.
...
type
  uart_event_t* {.importc: "uart_event_t", header: "uart.h", bycopy.} = object
...
proc uart_is_driver_installed*(uart_num: uart_port_t): bool {.cdecl,
    importc: "uart_is_driver_installed", header: "uart.h".}
## *
...
proc uart_set_word_length*(uart_num: uart_port_t; data_bit: uart_word_length_t): esp_err_t {.
    cdecl, importc: "uart_set_word_length", header: "uart.h".}
## *
...
proc uart_get_word_length*(uart_num: uart_port_t; data_bit: ptr uart_word_length_t): esp_err_t {.
    cdecl, importc: "uart_get_word_length", header: "uart.h".}
## *
...
proc uart_set_stop_bits*(uart_num: uart_port_t; stop_bits: uart_stop_bits_t): esp_err_t {.
    cdecl, importc: "uart_set_stop_bits", header: "uart.h".}
## *
...
proc uart_get_stop_bits*(uart_num: uart_port_t; stop_bits: ptr uart_stop_bits_t): esp_err_t {.
    cdecl, importc: "uart_get_stop_bits", header: "uart.h".}
## *
...
proc uart_set_parity*(uart_num: uart_port_t; parity_mode: uart_parity_t): esp_err_t {.
    cdecl, importc: "uart_set_parity", header: "uart.h".}
## *
...
proc uart_get_parity*(uart_num: uart_port_t; parity_mode: ptr uart_parity_t): esp_err_t {.
    cdecl, importc: "uart_get_parity", header: "uart.h".}
## *
...
proc uart_set_baudrate*(uart_num: uart_port_t; baudrate: uint32_t): esp_err_t {.cdecl,
    importc: "uart_set_baudrate", header: "uart.h".}
## *
...
proc uart_get_baudrate*(uart_num: uart_port_t; baudrate: ptr uint32_t): esp_err_t {.
    cdecl, importc: "uart_get_baudrate", header: "uart.h".}
## *
...
proc uart_set_line_inverse*(uart_num: uart_port_t; inverse_mask: uint32_t): esp_err_t {.
    cdecl, importc: "uart_set_line_inverse", header: "uart.h".}
## *
...
proc uart_set_hw_flow_ctrl*(uart_num: uart_port_t;
                           flow_ctrl: uart_hw_flowcontrol_t; rx_thresh: uint8_t): esp_err_t {.
    cdecl, importc: "uart_set_hw_flow_ctrl", header: "uart.h".}
## *
...
proc uart_set_sw_flow_ctrl*(uart_num: uart_port_t; enable: bool;
                           rx_thresh_xon: uint8_t; rx_thresh_xoff: uint8_t): esp_err_t {.
    cdecl, importc: "uart_set_sw_flow_ctrl", header: "uart.h".}
## *
...
proc uart_get_hw_flow_ctrl*(uart_num: uart_port_t;
    ...
    importc: "uart_get_hw_flow_ctrl", header: "uart.h".}
## *
...
proc uart_clear_intr_status*(uart_num: uart_port_t; clr_mask: uint32_t): esp_err_t {.
    cdecl, importc: "uart_clear_intr_status", header: "uart.h".}
## *
...
proc uart_enable_intr_mask*(uart_num: uart_port_t; enable_mask: uint32_t): esp_err_t {.
    cdecl, importc: "uart_enable_intr_mask", header: "uart.h".}
## *
...
proc uart_disable_intr_mask*(uart_num: uart_port_t; disable_mask: uint32_t): esp_err_t {.
    cdecl, importc: "uart_disable_intr_mask", header: "uart.h".}
## *
...
proc uart_enable_rx_intr*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_enable_rx_intr", header: "uart.h".}
## *
...
proc uart_disable_rx_intr*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_disable_rx_intr", header: "uart.h".}
## *
...
proc uart_disable_tx_intr*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_disable_tx_intr", header: "uart.h".}
## *
...
proc uart_enable_tx_intr*(uart_num: uart_port_t; enable: cint; thresh: cint): esp_err_t {.
    cdecl, importc: "uart_enable_tx_intr", header: "uart.h".}
## *
...
proc uart_isr_register*(uart_num: uart_port_t; fn: proc (a1: pointer) {.cdecl.};
    ...
    importc: "uart_isr_register", header: "uart.h".}
## *
...
proc uart_isr_free*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_isr_free", header: "uart.h".}
## *
...
proc uart_set_pin*(uart_num: uart_port_t; tx_io_num: cint; rx_io_num: cint;
    ...
    importc: "uart_set_pin", header: "uart.h".}
## *
...
proc uart_set_rts*(uart_num: uart_port_t; level: cint): esp_err_t {.cdecl,
    importc: "uart_set_rts", header: "uart.h".}
## *
...
proc uart_set_dtr*(uart_num: uart_port_t; level: cint): esp_err_t {.cdecl,
    importc: "uart_set_dtr", header: "uart.h".}
## *
...
proc uart_set_tx_idle_num*(uart_num: uart_port_t; idle_num: uint16_t): esp_err_t {.
    cdecl, importc: "uart_set_tx_idle_num", header: "uart.h".}
## *
...
proc uart_param_config*(uart_num: uart_port_t; uart_config: ptr uart_config_t): esp_err_t {.
    cdecl, importc: "uart_param_config", header: "uart.h".}
## *
...
proc uart_intr_config*(uart_num: uart_port_t; intr_conf: ptr uart_intr_config_t): esp_err_t {.
    cdecl, importc: "uart_intr_config", header: "uart.h".}
## *
...
proc uart_driver_install*(uart_num: uart_port_t; rx_buffer_size: cint;
    ...
    cdecl, importc: "uart_driver_install", header: "uart.h".}
## *
...
proc uart_driver_delete*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_driver_delete", header: "uart.h".}
## *
...
proc uart_wait_tx_done*(uart_num: uart_port_t; ticks_to_wait: TickType_t): esp_err_t {.
    cdecl, importc: "uart_wait_tx_done", header: "uart.h".}
## *
...
proc uart_tx_chars*(uart_num: uart_port_t; buffer: cstring; len: uint32_t): cint {.
    cdecl, importc: "uart_tx_chars", header: "uart.h".}
## *
##  @brief Send data to the UART port from a given buffer and length,
##
...
proc uart_write_bytes*(uart_num: uart_port_t; src: cstring; size: csize): cint {.cdecl,
    importc: "uart_write_bytes", header: "uart.h".}
## *
##  @brief Send data to the UART port from a given buffer and length,
##
##  If the UART driver's parameter 'tx_buffer_size' is set to zero:
...
proc uart_write_bytes_with_break*(uart_num: uart_port_t; src: cstring; size: csize;
    ...
    importc: "uart_write_bytes_with_break", header: "uart.h".}
## *
...
proc uart_read_bytes*(uart_num: uart_port_t; buf: ptr uint8_t; length: uint32_t;
                     ticks_to_wait: TickType_t): cint {.cdecl,
    importc: "uart_read_bytes", header: "uart.h".}
## *
...
proc uart_flush_input*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_flush_input", header: "uart.h".}
## *
...
proc uart_get_buffered_data_len*(uart_num: uart_port_t; size: ptr csize): esp_err_t {.
    cdecl, importc: "uart_get_buffered_data_len", header: "uart.h".}
## *
...
proc uart_disable_pattern_det_intr*(uart_num: uart_port_t): esp_err_t {.cdecl,
    importc: "uart_disable_pattern_det_intr", header: "uart.h".}
## *
...
proc uart_enable_pattern_det_intr*(uart_num: uart_port_t; pattern_chr: char;
                                  chr_num: uint8_t; chr_tout: cint; post_idle: cint;
                                  pre_idle: cint): esp_err_t {.cdecl,
    importc: "uart_enable_pattern_det_intr", header: "uart.h".}
## *
...
proc uart_pattern_pop_pos*(uart_num: uart_port_t): cint {.cdecl,
    importc: "uart_pattern_pop_pos", header: "uart.h".}
## *
##  @brief Return the nearest detected pattern position in buffer.
##         The positions of the detected pattern are saved in a queue,
...
proc uart_pattern_get_pos*(uart_num: uart_port_t): cint {.cdecl,
    importc: "uart_pattern_get_pos", header: "uart.h".}
## *
...
proc uart_pattern_queue_reset*(uart_num: uart_port_t; queue_length: cint): esp_err_t {.
    cdecl, importc: "uart_pattern_queue_reset", header: "uart.h".}
## *
...
proc uart_set_mode*(uart_num: uart_port_t; mode: uart_mode_t): esp_err_t {.cdecl,
    importc: "uart_set_mode", header: "uart.h".}
## *
...
proc uart_set_rx_timeout*(uart_num: uart_port_t; tout_thresh: uint8_t): esp_err_t {.
    cdecl, importc: "uart_set_rx_timeout", header: "uart.h".}
## *
...
proc uart_get_collision_flag*(uart_num: uart_port_t; collision_flag: ptr bool): esp_err_t {.
    cdecl, importc: "uart_get_collision_flag", header: "uart.h".}
## *
...
proc uart_set_wakeup_threshold*(uart_num: uart_port_t; wakeup_threshold: cint): esp_err_t {.
    cdecl, importc: "uart_set_wakeup_threshold", header: "uart.h".}
## *
...
proc uart_get_wakeup_threshold*(uart_num: uart_port_t;
    ...
    importc: "uart_get_wakeup_threshold", header: "uart.h".}