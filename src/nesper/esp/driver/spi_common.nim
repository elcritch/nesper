...
import
  esp_err, esp32/rom/lldesc, soc/spi_periph, hal/spi_types, sdkconfig
...
proc spi_bus_initialize*(host: spi_host_device_t; bus_config: ptr spi_bus_config_t;
                        dma_chan: cint): esp_err_t {.importc: "spi_bus_initialize",
    header: "spi_common.h".}
## *
...
proc spi_bus_free*(host: spi_host_device_t): esp_err_t {.importc: "spi_bus_free",
    header: "spi_common.h".}