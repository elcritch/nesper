...
var PERIPHS_IO_MUX_GPIO39_U* {.importc: "PERIPHS_IO_MUX_GPIO39_U", header: hdr.}: int  #           (DR_REG_IO_MUX_BASE +0x10)
var IO_MUX_GPIO39_REG* {.importc: "IO_MUX_GPIO39_REG", header: hdr.}: int  #                    PERIPHS_IO_MUX_GPIO39_U
var FUNC_GPIO39_GPIO39* {.importc: "FUNC_GPIO39_GPIO39", header: hdr.}: int  #                          2
var FUNC_GPIO39_GPIO39_0* {.importc: "FUNC_GPIO39_GPIO39_0", header: hdr.}: int  #                        0