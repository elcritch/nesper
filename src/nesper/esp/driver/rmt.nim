...
import
  esp_err, soc/rmt_periph, freertos/FreeRTOS, freertos/semphr, freertos/xtensa_api,
  freertos/ringbuf, driver/gpio, driver/periph_ctrl
...
proc rmt_isr_register*(fn: proc (a1: pointer); arg: pointer; intr_alloc_flags: cint;
