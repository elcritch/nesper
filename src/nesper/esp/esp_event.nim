...
type
  ...
  esp_event_loop_args_t* {.importc: "esp_event_loop_args_t",
                           header: "esp_event.h", bycopy.} = object ##
    ...
    task_priority* {.importc: "task_priority".}: UBaseType_t ##
                              ## < priority of the event loop task, ignored if task name is NULL
    task_stack_size* {.importc: "task_stack_size".}: uint32 ##
                              ## < stack size of the event loop task, ignored if task name is NULL
    task_core_id* {.importc: "task_core_id".}: BaseType_t
    ## < core to which the event loop task is pinned to,
...
proc esp_event_loop_create*(event_loop_args: ptr esp_event_loop_args_t;
    ...
    cdecl, importc: "esp_event_loop_create", header: "esp_event.h".}
  ##
                              ##
...
proc esp_event_loop_delete*(event_loop: esp_event_loop_handle_t): esp_err_t {.
    cdecl, importc: "esp_event_loop_delete", header: "esp_event.h".}
  ##
                              ##
...
proc esp_event_loop_create_default*(): esp_err_t {.cdecl,
...
proc esp_event_loop_delete_default*(): esp_err_t {.cdecl,
...
proc esp_event_loop_run*(event_loop: esp_event_loop_handle_t;
                         ticks_to_run: TickType_t): esp_err_t {.cdecl,
...
proc esp_event_handler_register*(event_base: esp_event_base_t; event_id: int32;
                                 ...
                                 event_handler_arg: pointer): esp_err_t {.cdecl,
...
proc esp_event_handler_register_with*(event_loop: esp_event_loop_handle_t;
    ...
    cdecl, importc: "esp_event_handler_register_with", header: "esp_event.h".}
  ##
                              ##
...
proc esp_event_handler_instance_register_with*(
    ...
    cdecl, importc: "esp_event_handler_instance_register_with",
    header: "esp_event.h".}
  ##
...
proc esp_event_handler_unregister*(event_base: esp_event_base_t;
                                   event_id: int32;
                                   event_handler: esp_event_handler_t): esp_err_t {.
    cdecl, importc: "esp_event_handler_unregister", header: "esp_event.h".}
  ##
                              ##
...
proc esp_event_handler_unregister_with*(event_loop: esp_event_loop_handle_t;
                                        ...
                                        event_id: int32;
                                        event_handler: esp_event_handler_t): esp_err_t {.
    cdecl, importc: "esp_event_handler_unregister_with", header: "esp_event.h".}
  ##
                              ##
...
proc esp_event_handler_instance_unregister_with*(
    event_loop: esp_event_loop_handle_t; event_base: esp_event_base_t;
    event_id: int32; instance: esp_event_handler_instance_t): esp_err_t {.cdecl,
...
proc esp_event_post*(event_base: esp_event_base_t; event_id: int32;
                     ...
                     ticks_to_wait: TickType_t): esp_err_t {.cdecl,
...
proc esp_event_isr_post*(event_base: esp_event_base_t; event_id: int32;
                          event_data: pointer; event_data_size: csize_t;
                          task_unblocked: ptr BaseType_t): esp_err_t {.cdecl,
...
proc esp_event_isr_post_to*(event_loop: esp_event_loop_handle_t;
    ...
    cdecl, importc: "esp_event_isr_post_to", header: "esp_event.h".}
  ##
                            ##
...
proc esp_event_dump*(file: ptr FILE): esp_err_t {.cdecl,
    importc: "esp_event_dump", header: "esp_event.h".}
  ##
                              ##
