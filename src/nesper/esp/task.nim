...
var errCOULD_NOT_ALLOCATE_REQUIRED_MEMORY* {.importc: "errCOULD_NOT_ALLOCATE_REQUIRED_MEMORY", header: "freertos/semphr.h".}: cint
var errQUEUE_BLOCKED* {.importc: "errQUEUE_BLOCKED", header: "freertos/semphr.h".}: cint
var errQUEUE_YIELD* {.importc: "errQUEUE_YIELD", header: "freertos/semphr.h".}: cint

##  Macros used for basic data corruption checks.

var configUSE_LIST_DATA_INTEGRITY_CHECK_BYTES* {.importc: "configUSE_LIST_DATA_INTEGRITY_CHECK_BYTES", header: "freertos/semphr.h".}: cint
var pdINTEGRITY_CHECK_VALUE* {.importc: "pdINTEGRITY_CHECK_VALUE", header: "freertos/semphr.h".}: cint

## -----------------------------------------------------------
##  MACROS AND DEFINITIONS
## ----------------------------------------------------------

var tskKERNEL_VERSION_NUMBER* {.importc: "tskKERNEL_VERSION_NUMBER", header: "freertos/semphr.h".}: cstring
var tskKERNEL_VERSION_MAJOR* {.importc: "tskKERNEL_VERSION_MAJOR", header: "freertos/semphr.h".}: cint
var tskKERNEL_VERSION_MINOR* {.importc: "tskKERNEL_VERSION_MINOR", header: "freertos/semphr.h".}: cint
var tskKERNEL_VERSION_BUILD* {.importc: "tskKERNEL_VERSION_BUILD", header: "freertos/semphr.h".}: cint

## *
##  @brief Argument of xTaskCreatePinnedToCore indicating that task has no affinity
##

var tskNO_AFFINITY* {.importc: "tskNO_AFFINITY", header: "freertos/semphr.h".}: cint
...
type
  TaskHandle_t* {.importc: "TaskHandle_t", header: "freertos/semphr.h".} = pointer
...
type
  TimeOut_t* {.importc: "TimeOut_t", header: "freertos/semphr.h", bycopy.} = object
...
type
  MemoryRegion_t* {.importc: "MemoryRegion_t", header: "freertos/semphr.h", bycopy.} = object
...
type
  TaskParameters_t* {.importc: "TaskParameters_t", header: "freertos/semphr.h", bycopy.} = object
...
type
  TaskStatus_t* {.importc: "TaskStatus_t", header: "freertos/semphr.h", bycopy.} = object
...
var xCoreID* {.importc: "xCoreID", header: "freertos/semphr.h".}: BaseType_t
...
type
  TaskSnapshot_t* {.importc: "TaskSnapshot_t", header: "freertos/semphr.h", bycopy.} = object
...
proc taskYIELD*() {.importc: "taskYIELD", header: "freertos/semphr.h".}
...
proc taskENTER_CRITICAL*(mux: portMUX_TYPE) {.importc: "taskENTER_CRITICAL", header: "freertos/semphr.h".}
...
proc taskEXIT_CRITICAL*() {.importc: "taskEXIT_CRITICAL", header: "freertos/semphr.h".}
...
proc taskDISABLE_INTERRUPTS*() {.importc: "taskDISABLE_INTERRUPTS", header: "freertos/semphr.h".}
...
proc taskENABLE_INTERRUPTS*() {.importc: "taskENABLE_INTERRUPTS", header: "freertos/semphr.h".}
...
proc xTaskCreatePinnedToCore*(pvTaskCode: TaskFunction_t;
    ...
    importc: "xTaskCreatePinnedToCore", header: "freertos/semphr.h".}
## *
...
proc xTaskCreateStaticPinnedToCore*(pvTaskCode: TaskFunction_t; pcName: cstring;
    ...
    importc: "xTaskCreateStaticPinnedToCore", header: "freertos/semphr.h".}
## *
##  Create a new task and add it to the list of tasks that are ready to run.
##
##  Internally, within the FreeRTOS implementation, tasks use two blocks of
...
proc xTaskCreateRestricted*(pxTaskDefinition: ptr TaskParameters_t;
    ...
    importc: "xTaskCreateRestricted", header: "freertos/semphr.h".}
## *
...
proc vTaskAllocateMPURegions*(xTask: TaskHandle_t; pxRegions: ptr MemoryRegion_t) {.
    importc: "vTaskAllocateMPURegions", header: "freertos/semphr.h".}
## * @endcond
## *
...
proc vTaskDelay*(xTicksToDelay: TickType_t) {.importc: "vTaskDelay", header: "freertos/semphr.h".}
## *
...
proc vTaskDelayUntil*(pxPreviousWakeTime: ptr TickType_t; xTimeIncrement: TickType_t) {.
    importc: "vTaskDelayUntil", header: "freertos/semphr.h".}
## *
...
proc uxTaskPriorityGet*(xTask: TaskHandle_t): UBaseType_t {.
    importc: "uxTaskPriorityGet", header: "freertos/semphr.h".}
## *
...
proc uxTaskPriorityGetFromISR*(xTask: TaskHandle_t): UBaseType_t {.
    importc: "uxTaskPriorityGetFromISR", header: "freertos/semphr.h".}
## *
...
proc vTaskPrioritySet*(xTask: TaskHandle_t; uxNewPriority: UBaseType_t) {.
    importc: "vTaskPrioritySet", header: "freertos/semphr.h".}
## *
##  Suspend a task.
##
...
proc xTaskResumeFromISR*(xTaskToResume: TaskHandle_t): BaseType_t {.
    importc: "xTaskResumeFromISR", header: "freertos/semphr.h".}
## -----------------------------------------------------------
##  SCHEDULER CONTROL
## ----------------------------------------------------------
## * @cond
...
proc vTaskStartScheduler*() {.importc: "vTaskStartScheduler", header: "freertos/semphr.h".}
## *
...
proc vTaskEndScheduler*() {.importc: "vTaskEndScheduler", header: "freertos/semphr.h".}
## * @endcond
## *
...
proc vTaskSuspendAll*() {.importc: "vTaskSuspendAll", header: "freertos/semphr.h".}
## *
...
proc xTaskResumeAll*(): BaseType_t {.importc: "xTaskResumeAll", header: "freertos/semphr.h".}
## -----------------------------------------------------------
##  TASK UTILITIES
## ----------------------------------------------------------
## *
...
proc pcTaskGetTaskName*(xTaskToQuery: TaskHandle_t): cstring {.
    importc: "pcTaskGetTaskName", header: "freertos/semphr.h".}
## lint !e971 Unqualified char types are allowed for strings and single characters only.
## *
...
proc uxTaskGetStackHighWaterMark*(xTask: TaskHandle_t): UBaseType_t {.
    importc: "uxTaskGetStackHighWaterMark", header: "freertos/semphr.h".}
## *
...
proc pxTaskGetStackStart*(xTask: TaskHandle_t): ptr uint8 {.
    importc: "pxTaskGetStackStart", header: "freertos/semphr.h".}
...
proc vTaskSetApplicationTaskTag*(xTask: TaskHandle_t;
    ...
    importc: "vTaskSetApplicationTaskTag", header: "freertos/semphr.h".}
## *
...
proc xTaskGetApplicationTaskTag*(xTask: TaskHandle_t): TaskHookFunction_t {.
    importc: "xTaskGetApplicationTaskTag", header: "freertos/semphr.h".}
## *
...
proc vTaskSetThreadLocalStoragePointer*(xTaskToSet: TaskHandle_t;
    ...
    importc: "vTaskSetThreadLocalStoragePointer", header: "freertos/semphr.h".}
## *
...
proc pvTaskGetThreadLocalStoragePointer*(xTaskToQuery: TaskHandle_t;
    ...
    importc: "pvTaskGetThreadLocalStoragePointer", header: "freertos/semphr.h".}
## *
...
proc vTaskSetThreadLocalStoragePointerAndDelCallback*(xTaskToSet: TaskHandle_t;
    ...
    importc: "vTaskSetThreadLocalStoragePointerAndDelCallback", header: "freertos/semphr.h".}
## *
...
proc xTaskCallApplicationTaskHook*(xTask: TaskHandle_t; pvParameter: pointer): BaseType_t {.
    importc: "xTaskCallApplicationTaskHook", header: "freertos/semphr.h".}
## *
...
proc xTaskGetIdleTaskHandleForCPU*(cpuid: UBaseType_t): TaskHandle_t {.
    importc: "xTaskGetIdleTaskHandleForCPU", header: "freertos/semphr.h".}
## *
...
proc uxTaskGetSystemState*(pxTaskStatusArray: ptr TaskStatus_t;
    ...
    importc: "uxTaskGetSystemState", header: "freertos/semphr.h".}
## *
...
proc vTaskList*(pcWriteBuffer: cstring) {.importc: "vTaskList", header: "freertos/semphr.h".}
## lint !e971 Unqualified char types are allowed for strings and single characters only.
## *
...
proc vTaskGetRunTimeStats*(pcWriteBuffer: cstring) {.
    importc: "vTaskGetRunTimeStats", header: "freertos/semphr.h".}
## lint !e971 Unqualified char types are allowed for strings and single characters only.
## *
...
proc xTaskNotifyFromISR*(xTaskToNotify: TaskHandle_t; ulValue: uint32;
    ...
    importc: "xTaskNotifyFromISR", header: "freertos/semphr.h".}
## *
...
proc xTaskNotifyWait*(ulBitsToClearOnEntry: uint32;
    ...
    importc: "xTaskNotifyWait", header: "freertos/semphr.h".}
## *
...
proc xTaskNotifyGive*(xTaskToNotify: TaskHandle_t): BaseType_t {.
    importc: "xTaskNotifyGive", header: "freertos/semphr.h".}
...
proc vTaskNotifyGiveFromISR*(xTaskToNotify: TaskHandle_t;
    ...
    importc: "vTaskNotifyGiveFromISR", header: "freertos/semphr.h".}
## *
...
proc ulTaskNotifyTake*(xClearCountOnExit: BaseType_t; xTicksToWait: TickType_t): uint32 {.
    importc: "ulTaskNotifyTake", header: "freertos/semphr.h".}
...
#     importc: "vTaskPlaceOnEventList", header: "freertos/semphr.h".}
# proc vTaskPlaceOnUnorderedEventList*(pxEventList: ptr List_t;
#                                     xItemValue: TickType_t;
#                                     xTicksToWait: TickType_t) {.
#     importc: "vTaskPlaceOnUnorderedEventList", header: "freertos/semphr.h".}
...
#                                      xTicksToWait: TickType_t) {.
#     importc: "vTaskPlaceOnEventListRestricted", header: "freertos/semphr.h".}
...
#     importc: "xTaskRemoveFromEventList", header: "freertos/semphr.h".}
# proc xTaskRemoveFromUnorderedEventList*(pxEventListItem: ptr ListItem_t;
#                                        xItemValue: TickType_t): BaseType_t {.
#     importc: "xTaskRemoveFromUnorderedEventList", header: "freertos/semphr.h".}
...
# proc vTaskSwitchContext*() {.importc: "vTaskSwitchContext", header: "freertos/semphr.h".}
...
#     importc: "uxTaskResetEventItemValue", header: "freertos/semphr.h".}
...
proc xTaskGetCurrentTaskHandle*(): TaskHandle_t {.
    importc: "xTaskGetCurrentTaskHandle", header: "freertos/semphr.h".}
##
...
proc xTaskGetCurrentTaskHandleForCPU*(cpuid: BaseType_t): TaskHandle_t {.
    importc: "xTaskGetCurrentTaskHandleForCPU", header: "freertos/semphr.h".}
##
##  Capture the current time status for future reference.
##

proc vTaskSetTimeOutState*(pxTimeOut: ptr TimeOut_t) {.
    importc: "vTaskSetTimeOutState", header: "freertos/semphr.h".}
##
...
proc xTaskCheckForTimeOut*(pxTimeOut: ptr TimeOut_t; pxTicksToWait: ptr TickType_t): BaseType_t {.
    importc: "xTaskCheckForTimeOut", header: "freertos/semphr.h".}
##
##  Shortcut used by the queue implementation to prevent unnecessary call to
##  taskYIELD();
##

proc vTaskMissedYield*() {.importc: "vTaskMissedYield", header: "freertos/semphr.h".}
##
...
proc vTaskPriorityInherit*(pxMutexHolder: TaskHandle_t) {.
    importc: "vTaskPriorityInherit", header: "freertos/semphr.h".}
##
...
proc vTaskSetTaskNumber*(xTask: TaskHandle_t; uxHandle: UBaseType_t) {.
    importc: "vTaskSetTaskNumber", header: "freertos/semphr.h".}
##
...
proc eTaskConfirmSleepModeStatus*(): eSleepModeStatus {.
    importc: "eTaskConfirmSleepModeStatus", header: "freertos/semphr.h".}
##
...
proc pvTaskIncrementMutexHeldCount*(): pointer {.
    importc: "pvTaskIncrementMutexHeldCount", header: "freertos/semphr.h".}
##
...
proc uxTaskGetSnapshotAll*(pxTaskSnapshotArray: ptr TaskSnapshot_t;
    ...
    importc: "uxTaskGetSnapshotAll", header: "freertos/semphr.h".}
## * @endcond
