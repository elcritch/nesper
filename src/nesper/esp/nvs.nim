...
const
  ...
  ESP_ERR_NVS_XTS_ENCR_FAILED* = (ESP_ERR_NVS_BASE + 0x11) ##
                              ## !< XTS encryption failed while writing NVS entry
  ESP_ERR_NVS_XTS_DECR_FAILED* = (ESP_ERR_NVS_BASE + 0x12) ##
                              ## !< XTS decryption failed while reading NVS entry
  ESP_ERR_NVS_XTS_CFG_FAILED* = (ESP_ERR_NVS_BASE + 0x13) ##
                              ## !< XTS configuration setting failed
  ESP_ERR_NVS_XTS_CFG_NOT_FOUND* = (ESP_ERR_NVS_BASE + 0x14) ##
                              ## !< XTS configuration not found
  ESP_ERR_NVS_ENCR_NOT_SUPPORTED* = (ESP_ERR_NVS_BASE + 0x15) ##
                              ## !< NVS encryption is not supported in this version
  ESP_ERR_NVS_KEYS_NOT_INITIALIZED* = (ESP_ERR_NVS_BASE + 0x16) ##
                              ## !< NVS key partition is uninitialized
  ESP_ERR_NVS_CORRUPT_KEY_PART* = (ESP_ERR_NVS_BASE + 0x17) ##
                              ## !< NVS key partition is corrupt
  ESP_ERR_NVS_WRONG_ENCRYPTION* = (ESP_ERR_NVS_BASE + 0x19) ##
  ...
  ESP_ERR_NVS_CONTENT_DIFFERS* = (ESP_ERR_NVS_BASE + 0x18) ##
  ...
  NVS_NS_NAME_MAX_SIZE* = NVS_KEY_NAME_MAX_SIZE
...
type
  ...
  nvs_entry_info_t* {.importc: "nvs_entry_info_t", header: "nvs.h", bycopy.} = object ##
                              ...
                              ##
    namespace_name* {.importc: "namespace_name".}: array[NVS_NS_NAME_MAX_SIZE,
        char]                ## !< Namespace to which key-value belong
    key* {.importc: "key".}: array[NVS_KEY_NAME_MAX_SIZE, char] ##
                              ## !< Key of stored key-value pair
    `type`* {.importc: "type".}: nvs_type_t
...
proc nvs_open*(namespace_name: cstring; open_mode: nvs_open_mode_t;
               out_handle: ptr nvs_handle_t): esp_err_t {.cdecl,
    importc: "nvs_open", header: "nvs.h".}
  ##
...
proc nvs_open_from_partition*(part_name: cstring; namespace_name: cstring;
...
proc nvs_set_i8*(handle: nvs_handle_t; key: cstring; value: int8): esp_err_t {.
    cdecl, importc: "nvs_set_i8", header: "nvs.h".}
  ##
                              ## @{
                              ##
...
proc nvs_set_u8*(handle: nvs_handle_t; key: cstring; value: uint8): esp_err_t {.
    cdecl, importc: "nvs_set_u8", header: "nvs.h".}
  ##
                              ##
...
proc nvs_set_blob*(handle: nvs_handle_t; key: cstring; value: pointer;
                   length: csize_t): esp_err_t {.cdecl, importc: "nvs_set_blob",
    header: "nvs.h".}
  ## @}
                     ##
...
proc nvs_get_str*(handle: nvs_handle_t; key: cstring; out_value: cstring;
                  length: ptr csize_t): esp_err_t {.cdecl,
    importc: "nvs_get_str", header: "nvs.h".}
  ## @}
                                             ## @{
                                             ##
...
proc nvs_get_blob*(handle: nvs_handle_t; key: cstring; out_value: pointer;
                   length: ptr csize_t): esp_err_t {.cdecl,
    importc: "nvs_get_blob", header: "nvs.h".}
  ##
...
proc nvs_find_key*(handle: nvs_handle_t; key: cstring; out_type: ptr nvs_type_t): esp_err_t {.
    cdecl, importc: "nvs_find_key", header: "nvs.h".}
  ##
                              ## @}
                              ##
...
proc nvs_commit*(handle: nvs_handle_t): esp_err_t {.cdecl,
    importc: "nvs_commit", header: "nvs.h".}
  ##
...
proc nvs_close*(handle: nvs_handle_t) {.cdecl, importc: "nvs_close",
                                        header: "nvs.h".}
  ##
                              ##
...
type
  ...
  nvs_stats_t* {.importc: "nvs_stats_t", header: "nvs.h", bycopy.} = object ##
                              ...
                              ##
    used_entries* {.importc: "used_entries".}: csize_t ##
                              ## < Number of used entries.
    free_entries* {.importc: "free_entries".}: csize_t ##
                              ## < Number of free entries. It includes also reserved entries.
    available_entries* {.importc: "available_entries".}: csize_t ##
                              ## < Number of entries available for data storage.
    total_entries* {.importc: "total_entries".}: csize_t ##
                              ## < Number of all entries.
    namespace_count* {.importc: "namespace_count".}: csize_t
    ## < Number of namespaces.



proc nvs_get_stats*(part_name: cstring; nvs_stats: ptr nvs_stats_t): esp_err_t {.
    cdecl, importc: "nvs_get_stats", header: "nvs.h".}
  ##
                              ##
...
proc nvs_entry_find*(part_name: cstring; namespace_name: cstring;
                     `type`: nvs_type_t; output_iterator: ptr nvs_iterator_t): esp_err_t {.
...
proc nvs_entry_find_in_handle*(handle: nvs_handle_t; `type`: nvs_type_t;
                               output_iterator: ptr nvs_iterator_t): esp_err_t {.
    cdecl, importc: "nvs_entry_find_in_handle", header: "nvs.h".}
  ##
                              ##
...
proc nvs_entry_next*(`iterator`: ptr nvs_iterator_t): esp_err_t {.cdecl,
