...
type
  esp_line_endings_t* {.importc: "esp_line_endings_t", header: "esp_vfs_dev.h", bycopy.} = enum
...
proc esp_vfs_dev_uart_register*() {.cdecl, importc: "esp_vfs_dev_uart_register",
                                  header: "esp_vfs_dev.h".}
## *
...
proc esp_vfs_dev_uart_set_rx_line_endings*(mode: esp_line_endings_t) {.cdecl,
    importc: "esp_vfs_dev_uart_set_rx_line_endings", header: "esp_vfs_dev.h".}
## *
...
proc esp_vfs_dev_uart_set_tx_line_endings*(mode: esp_line_endings_t) {.cdecl,
    importc: "esp_vfs_dev_uart_set_tx_line_endings", header: "esp_vfs_dev.h".}
## *
...
proc esp_vfs_dev_uart_use_nonblocking*(uart_num: cint) {.cdecl,
    importc: "esp_vfs_dev_uart_use_nonblocking", header: "esp_vfs_dev.h".}
## *
...
proc esp_vfs_dev_uart_use_driver*(uart_num: cint) {.cdecl,
    importc: "esp_vfs_dev_uart_use_driver", header: "esp_vfs_dev.h".}